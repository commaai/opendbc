...
class TestVolkswagenMebLongSafety(TestVolkswagenMebSafetyBase):
  ...
  FWD_BLACKLISTED_ADDRS = {0: [MSG_KLR_01],
                           2: [MSG_HCA_03, MSG_LDW_02, MSG_MEB_ACC_01, MSG_ACC_18, MSG_TA_01, MSG_EA_02]}
  RELAY_MALFUNCTION_ADDRS = {0: (MSG_HCA_03, MSG_LDW_02, MSG_MEB_ACC_01, MSG_ACC_18, MSG_TA_01, MSG_EA_02),
                             2: (MSG_KLR_01,)}
