...
static void volkswagen_mqb_rx_hook(const CANPacket_t *msg) {
  ...
  if (ADDR_BUS_MATCH(msg, MSG_ESP_19, 0U)) {
    // sum 4 wheel speeds
    int speed = 0;
  ...
  if (ADDR_BUS_MATCH(msg, MSG_TSK_06, 0U)) {
  ...
  if (ADDR_BUS_MATCH(msg, MSG_GRA_ACC_01, 0U)) {
