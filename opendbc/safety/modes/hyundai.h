...
static bool hyundai_tx_hook(const CANPacket_t *msg) {
  ...
  const TorqueSteeringLimits HYUNDAI_STEERING_LIMITS_HEAVY = HYUNDAI_LIMITS(404, 3, 7);
  ...
  if (msg->addr == 0x340U) {
    ...
    const TorqueSteeringLimits limits = hyundai_alt_limits_2 ? HYUNDAI_STEERING_LIMITS_ALT_2 :
                                        ...
                                        hyundai_heavy_limits ? HYUNDAI_STEERING_LIMITS_HEAVY : HYUNDAI_STEERING_LIMITS;
