...
static safety_config volkswagen_pq_init(uint16_t param) {
  ...
  static RxCheck volkswagen_pq_rx_checks[] = {
    ...
    {.msg = {{MSG_BREMSE_1, 0, 8, .skip_checksum = true, .max_counter = 0U, .frequency = 100U}, { 0 }, { 0 }}},
    {.msg = {{MSG_MOTOR_2, 0, 8, .skip_checksum = true, .max_counter = 0U, .frequency = 50U}, { 0 }, { 0 }}},
    {.msg = {{MSG_MOTOR_3, 0, 8, .skip_checksum = true, .max_counter = 0U, .frequency = 100U}, { 0 }, { 0 }}},
