...
static safety_config volkswagen_pq_init(uint16_t param) {
  ...
  static const CanMsg VOLKSWAGEN_PQ_STOCK_TX_MSGS[] = {{MSG_HCA_1, 0, 5, true, false}, {MSG_LDW_1, 0, 8, false, false},
                                                {MSG_GRA_NEU, 0, 4, false, false}, {MSG_GRA_NEU, 2, 4, false, false}};

  static const CanMsg VOLKSWAGEN_PQ_LONG_TX_MSGS[] =  {{MSG_HCA_1, 0, 5, true, false}, {MSG_LDW_1, 0, 8, false, false},
                                                {MSG_ACC_SYSTEM, 0, 8, false, false}, {MSG_ACC_GRA_ANZEIGE, 0, 8, false, false}};
