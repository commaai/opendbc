...
static safety_config volkswagen_pq_init(uint16_t param) {
  ...
  static RxCheck volkswagen_pq_rx_checks[] = {
    ...
    {.msg = {{MSG_BREMSE_1, 0, 8, .ignore_checksum = true, .skip_counter = true, .frequency = 100U}, { 0 }, { 0 }}},
    {.msg = {{MSG_MOTOR_2, 0, 8, .ignore_checksum = true, .skip_counter = true, .frequency = 50U}, { 0 }, { 0 }}},
    {.msg = {{MSG_MOTOR_3, 0, 8, .ignore_checksum = true, .skip_counter = true, .frequency = 100U}, { 0 }, { 0 }}},
    {.msg = {{MSG_MOTOR_5, 0, 8, .skip_counter = true, .frequency = 50U}, { 0 }, { 0 }}},
