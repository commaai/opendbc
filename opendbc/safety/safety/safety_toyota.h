...
#define TOYOTA_COMMON_RX_CHECKS(lta)                                                                        \
  ...
  {.msg = {{0x260, 0, 8, .ignore_checksum = false, .ignore_counter = true, .quality_flag = (lta), .frequency = 50U}, { 0 }, { 0 }}},  \
  {.msg = {{0x1D2, 0, 8, .ignore_checksum = false, .ignore_counter = true, .frequency = 33U},                                         \
           {0x176, 0, 8, .ignore_checksum = false, .ignore_counter = true, .frequency = 32U}, { 0 }}},                                \
