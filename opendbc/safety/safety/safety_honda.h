...
static safety_config honda_nidec_init(uint16_t param) {
  static CanMsg HONDA_N_TX_MSGS[] = {{0xE4, 0, 5, true, false}, {0x194, 0, 4, true, false}, {0x1FA, 0, 8, false, false}, {0x30C, 0, 8, false, false}, {0x33D, 0, 5, false, false}};
...
static safety_config honda_bosch_init(uint16_t param) {
  static CanMsg HONDA_BOSCH_TX_MSGS[] = {{0xE4, 0, 5, true, false}, {0xE5, 0, 8, false, false}, {0x296, 1, 4, false, false}, {0x33D, 0, 5, false, false}, {0x33DA, 0, 5, false, false}, {0x33DB, 0, 8, false, false}};  // Bosch
  static CanMsg HONDA_BOSCH_LONG_TX_MSGS[] = {{0xE4, 1, 5, true, false}, {0x1DF, 1, 8, true, false}, {0x1EF, 1, 8, false, false}, {0x1FA, 1, 8, false, false}, {0x30C, 1, 8, false, false}, {0x33D, 1, 5, false, false}, {0x33DA, 1, 5, false, false}, {0x33DB, 1, 8, false, false}, {0x39F, 1, 8, false, false}, {0x18DAB0F1, 1, 8, false, false}};  // Bosch w/ gas and brakes
  static CanMsg HONDA_RADARLESS_TX_MSGS[] = {{0xE4, 0, 5, true, false}, {0x296, 2, 4, false, false}, {0x33D, 0, 8, false, false}};  // Bosch radarless
  static CanMsg HONDA_RADARLESS_LONG_TX_MSGS[] = {{0xE4, 0, 5, true, false}, {0x33D, 0, 8, false, false}, {0x1C8, 0, 8, false, false}, {0x30C, 0, 8, false, false}};  // Bosch radarless w/ gas and brakes
