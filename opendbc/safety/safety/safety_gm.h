...
static safety_config gm_init(uint16_t param) {
  ...
  static const CanMsg GM_ASCM_TX_MSGS[] = {{0x180, 0, 4, true, false}, {0x409, 0, 7, false, false}, {0x40A, 0, 7, false, false}, {0x2CB, 0, 8, true, false}, {0x370, 0, 6, false, false},  // pt bus
                                           {0xA1, 1, 7, false, false}, {0x306, 1, 8, false, false}, {0x308, 1, 7, false, false}, {0x310, 1, 2, false, false},   // obs bus
                                           {0x315, 2, 5, false, false}};  // ch bus
  ...
  static const CanMsg GM_CAM_LONG_TX_MSGS[] = {{0x180, 0, 4, true, false}, {0x315, 0, 5, false, false}, {0x2CB, 0, 8, true, false}, {0x370, 0, 6, false, false},  // pt bus
                                               {0x184, 2, 8, false, false}};  // camera bus
  ...
  static const CanMsg GM_CAM_TX_MSGS[] = {{0x180, 0, 4, true, false},  // pt bus
                                          {0x1E1, 2, 7, false, false}, {0x184, 2, 8, false, false}};  // camera bus
