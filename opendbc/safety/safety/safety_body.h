...
static safety_config body_init(uint16_t param) {
  ...
  static const CanMsg BODY_TX_MSGS[] = {{0x250, 0, 8, false, false}, {0x250, 0, 6, false, false}, {0x251, 0, 5, false, false},  // body
                                        {0x350, 0, 8, false, false}, {0x350, 0, 6, false, false}, {0x351, 0, 5, false, false},  // knee
                                        {0x1, 0, 8, false, false}}; // CAN flasher
