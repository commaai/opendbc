...
#define HYUNDAI_CANFD_CRUISE_BUTTON_TX_MSGS(bus) \
  {0x1CF, bus, 8, false, false},  /* CRUISE_BUTTON */   \

#define HYUNDAI_CANFD_LKA_STEERING_COMMON_TX_MSGS(a_can, e_can) \
  HYUNDAI_CANFD_CRUISE_BUTTON_TX_MSGS(e_can)                    \
  {0x50,  a_can, 16, (a_can) == 0, false},  /* LKAS */                 \
  {0x2A4, a_can, 24, false, false},         /* CAM_0x2A4 */            \

#define HYUNDAI_CANFD_LKA_STEERING_ALT_COMMON_TX_MSGS(a_can, e_can) \
  HYUNDAI_CANFD_CRUISE_BUTTON_TX_MSGS(e_can)                        \
  {0x110, a_can, 32, (a_can) == 0, false},  /* LKAS_ALT */                 \
  {0x362, a_can, 32, false, false},         /* CAM_0x362 */                \

#define HYUNDAI_CANFD_LFA_STEERING_COMMON_TX_MSGS(e_can)  \
  {0x12A, e_can, 16, (e_can) == 0, false},  /* LFA */            \
  {0x1E0, e_can, 16, false, false},         /* LFAHDA_CLUSTER */ \

#define HYUNDAI_CANFD_SCC_CONTROL_COMMON_TX_MSGS(e_can, longitudinal)   \
  {0x1A0, e_can, 32, (longitudinal), false},  /* SCC_CONTROL */                \
...
static safety_config hyundai_canfd_init(uint16_t param) {
  ...
  static const CanMsg HYUNDAI_CANFD_LKA_STEERING_LONG_TX_MSGS[] = {
    ...
    {0x51,  0, 32, false, false},  // ADRV_0x51
    {0x730, 1,  8, false, false},  // tester present for ADAS ECU disable
    {0x160, 1, 16, false, false},  // ADRV_0x160
    {0x1EA, 1, 32, false, false},  // ADRV_0x1ea
    {0x200, 1,  8, false, false},  // ADRV_0x200
    {0x345, 1,  8, false, false},  // ADRV_0x345
    {0x1DA, 1, 32, false, false},  // ADRV_0x1da
  };
  ...
  static const CanMsg HYUNDAI_CANFD_LFA_STEERING_LONG_TX_MSGS[] = {
    ...
    {0x160, 0, 16, false, false}, // ADRV_0x160
    {0x7D0, 0, 8, false, false},  // tester present for radar ECU disable
  };
