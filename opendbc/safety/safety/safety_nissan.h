...
static safety_config nissan_init(uint16_t param) {
  static const CanMsg NISSAN_TX_MSGS[] = {
    {0x169, 0, 8, true, false},   // LKAS
    {0x2b1, 0, 8, false, false},  // PROPILOT_HUD
    {0x4cc, 0, 8, false, false},  // PROPILOT_HUD_INFO_MSG
    {0x20b, 2, 6, false, false},  // CRUISE_THROTTLE (X-Trail)
    {0x20b, 1, 6, false, false},  // CRUISE_THROTTLE (Altima)
    {0x280, 2, 8, false, false}   // CANCEL_MSG (Leaf)
  };
