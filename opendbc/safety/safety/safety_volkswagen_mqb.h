...
static safety_config volkswagen_mqb_init(uint16_t param) {
  ...
  static RxCheck volkswagen_mqb_rx_checks[] = {
    {.msg = {{MSG_ESP_19, 0, 8, .ignore_checksum = true, .skip_counter = true, .frequency = 100U}, { 0 }, { 0 }}},
    ...
    {.msg = {{MSG_MOTOR_14, 0, 8, .ignore_checksum = true, .skip_counter = true, .frequency = 10U}, { 0 }, { 0 }}},
