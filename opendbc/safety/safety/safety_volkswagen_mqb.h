...
static safety_config volkswagen_mqb_init(uint16_t param) {
  ...
  static const CanMsg VOLKSWAGEN_MQB_STOCK_TX_MSGS[] = {{MSG_HCA_01, 0, 8, true, false}, {MSG_GRA_ACC_01, 0, 8, false, false}, {MSG_GRA_ACC_01, 2, 8, false, false},
                                                        {MSG_LDW_02, 0, 8, false, false}, {MSG_LH_EPS_03, 2, 8, false, false}};

  static const CanMsg VOLKSWAGEN_MQB_LONG_TX_MSGS[] = {{MSG_HCA_01, 0, 8, true, false}, {MSG_LDW_02, 0, 8, false, false}, {MSG_LH_EPS_03, 2, 8, false, false},
                                                       {MSG_ACC_02, 0, 8, false, false}, {MSG_ACC_06, 0, 8, false, false}, {MSG_ACC_07, 0, 8, false, false}};
