# Python implementation of CANPacker
...
class Signal:
    ...
    calc_checksum: Optional[Callable[[int, "Signal", bytearray], int]] = None
...
class ChecksumState:
    ...
    little_endian: bool
    checksum_type: int
    calc_checksum: Optional[Callable[[int, Signal, bytearray], int]]
    setup_signal: Optional[Callable[[Signal, str, int], None]] = None
...
def set_signal_type(sig: Signal, chk: Optional[ChecksumState], dbc_name: str, line_num: int) -> None:
