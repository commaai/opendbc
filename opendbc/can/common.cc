...
static const std::unordered_map<uint32_t, std::array<uint8_t, 16>> crc_mqb_constants{
    ...
    // ACC_07 Automatic Cruise Control
    {0x12E, {0xF8, 0xE5, 0x97, 0xC9, 0xD6, 0x07, 0x47, 0x21, 0x66, 0xDD, 0xCF, 0x6F, 0xA1, 0x94, 0x74, 0x63}},

    // EV_Gearshift "Gear" selection data for EVs with no gearbox
    {0x187, {0x7F, 0xED, 0x17, 0xC2, 0x7C, 0xEB, 0x44, 0x21, 0x01, 0xFA, 0xDB, 0x15, 0x4A, 0x6B, 0x23, 0x05}},

    // ACC_02 Automatic Cruise Control
    {0x30C, {0x0F}},

    // SWA_01 Lane Change Assist (SpurWechselAssistent)
    {0x30F, {0x0C}},

    // ACC_04 Automatic Cruise Control
    {0x324, {0x27}},

    // Klemmen_Status_01 ignition and starting status
    {0x3C0, {0xC3}},

    // ESP_20 Electronic Stability Program
