...
class TestCanChecksums:
  ...
  def verify_mqb_crc(self, subtests, msg_name: str, msg_addr: int, test_messages: list[int], crc_field: str = 'CHECKSUM', counter_field: str = 'COUNTER'):
      """Validates checksum calculation for each message provided"""
  ...
  def test_mqb_crc_ACC_02(self, subtests):
      self.verify_mqb_crc(subtests, "ACC_02", 780, [
  ...
  def test_mqb_crc_LH_EPS_03(self, subtests):
      self.verify_mqb_crc(subtests, "LH_EPS_03", 0x9F, [
  ...
  @pytest.mark.skip(reason="This message has broken COUNTER behavior, see opendbc#1235")
  ...
  def test_mqb_crc_ESP_05(self, subtests):
      self.verify_mqb_crc(subtests, "ESP_05", 0x106, [
  ...
  def test_mqb_crc_ACC_10(self, subtests):
      self.verify_mqb_crc(subtests, "ACC_10", 0x117, [
  ...
  def test_mqb_crc_TSK_06(self, subtests):
      self.verify_mqb_crc(subtests, "TSK_06", 0x120, [
  ...
  def test_mqb_crc_ACC_06(self, subtests):
      self.verify_mqb_crc(subtests, "ACC_06", 0x122, [
  ...
  def test_mqb_crc_HCA_01(self, subtests):
      self.verify_mqb_crc(subtests, "HCA_01", 0x126, [
  ...
  def test_mqb_crc_GRA_ACC_01(self, subtests):
      self.verify_mqb_crc(subtests, "GRA_ACC_01", 0x12B, [
  ...
  def test_mqb_crc_ACC_07(self, subtests):
      self.verify_mqb_crc(subtests, "ACC_07", 0x12E, [
  ...
  def test_mqb_crc_SWA_01(self, subtests):
      self.verify_mqb_crc(subtests, "SWA_01", 0x30F, [
          ...
          b'\xda\x01\xf2\x00\x10\x00\x00\x00',
          b'\xc3\x02\xf2\x00\x10\x01\x00\x00',
          b'\x12\x03\xf2\x00\x10\x00\x00\x00',
          b'\xb4\x04\xf2\x00\x10\x01\x00\x00',
          b'\x65\x05\xf2\x00\x10\x00\x00\x00',
          b'\xc9\x06\xf2\x00\x10\x00\x00\x00',
          b'\x18\x07\xf2\x00\x10\x01\x00\x00',
          b'\xef\x08\xf2\x00\x10\x00\x00\x00',
          b'\x8b\x09\xf2\x00\x10\x00\x00\x00',
          b'\x92\x0a\xf2\x00\x10\x01\x00\x00',
          b'\xf6\x0b\xf2\x00\x10\x01\x00\x00',
          b'\x50\x0c\xf2\x00\x10\x00\x00\x00',
          b'\x34\x0d\xf2\x00\x10\x00\x00\x00',
          b'\x98\x0e\xf2\x00\x10\x00\x00\x00',
          b'\x49\x0f\xf2\x00\x10\x01\x00\x00',
      ])

  def test_mqb_crc_ACC_04(self, subtests):
      self.verify_mqb_crc(subtests, "ACC_04", 0x324, [
  ...
  def test_mqb_crc_Klemmen_Status_01(self, subtests):
      self.verify_mqb_crc(subtests, "Klemmen_Status_01", 0x3C0, [
          b'\x74\x00\x03\x00',
          b'\xc1\x01\x03\x00',
          b'\x31\x02\x03\x00',
          b'\x84\x03\x03\x00',
