...
class TestCanChecksums:
  ...
  def verify_fca_giorgio_checksum(self, subtests, msg_name: str, msg_addr: int, test_messages: list[bytes]):
  ...
  def test_fca_giorgio_EPS_1(self, subtests):
    self.verify_fca_giorgio_checksum(subtests, "EPS_1", 0xDE, [
  ...
  def test_fca_giorgio_EPS_2(self, subtests):
    self.verify_fca_giorgio_checksum(subtests, "EPS_2", 0x106, [
  ...
  def test_fca_giorgio_EPS_3(self, subtests):
    self.verify_fca_giorgio_checksum(subtests, "EPS_3", 0x122, [
      b'\x7b\x30\x00\xf8',
      b'\x7b\x10\x01\x90',
      b'\x7b\xf0\x02\x6e',
    ])
  ...
  def test_fca_giorgio_ABS_2(self, subtests):
    self.verify_fca_giorgio_checksum(subtests, "ABS_2", 0xfe, [
