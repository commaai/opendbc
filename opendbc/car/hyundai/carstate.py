...
class CarState(CarStateBase):
  ...
  def update_canfd(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.flags & HyundaiFlags.CANFD_HDA2 and self.CP.flags & HyundaiFlags.CANFD_BLOCK_LFA:
  ...
  def get_can_parsers_canfd(self, CP):
    ...
    cam_messages = []
    if CP.flags & HyundaiFlags.CANFD_HDA2 and CP.flags & HyundaiFlags.CANFD_BLOCK_LFA:
