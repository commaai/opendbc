...
from opendbc.car.body.values import SPEED_FROM_RPM, BIN_PATH, BIN_URL, FLASH_ADDR, UDS_TX, UDS_RX, BUS
...
class CarInterface(CarInterfaceBase):
  ...
  def init(CP, can_recv, can_send, communication_control=None):
    update(FLASH_ADDR, BUS, BIN_PATH, BIN_URL, can_send, can_recv, UDS_TX, UDS_RX, BUS)
