...
# TODO: the offsets were all negative but breaking the tests, removed negation. Also 0x100 exceeded uint8 subaddress. Please check.
PSA_RX_OFFSETS = {
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  extra_ecus=[
    ...
    # TODO: the offsets (0x100, 0x20...) were all negative but breaking the tests, also 0x100 exceeds uint8 subaddress. Please check.
    # (Ecu.eps, 0x75D, 0x100),
    (Ecu.abs, 0x6AD, 0x20),
