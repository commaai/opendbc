...
class CAR(Platforms):
  ...
  CHEVROLET_VOLT = GMASCMPlatformConfig(
    [GMCarDocs("Chevrolet Volt 2017-18", powertrain=PowertrainType.PHEV, min_enable_speed=0, video_link="https://youtu.be/QeMCN_4TFfQ")],
  ...
  CHEVROLET_BOLT_EUV = GMPlatformConfig(
    [
      GMCarDocs("Chevrolet Bolt EUV 2022-23", "Premier or Premier Redline Trim without Super Cruise Package", powertrain=PowertrainType.EV, video_link="https://youtu.be/xvwzGMUA210"),
      GMCarDocs("Chevrolet Bolt EV 2022-23", "2LT Trim with Adaptive Cruise Control Package", powertrain=PowertrainType.EV),
    ],
  ...
  CHEVROLET_VOLT_2019 = GMSDGMPlatformConfig(
    [GMCarDocs("Chevrolet Volt 2019", "Adaptive Cruise Control (ACC) & LKAS", powertrain=PowertrainType.PHEV)],
