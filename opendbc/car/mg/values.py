...
class CAR(Platforms):
  MG_5_EV = MgPlatformConfig(
    ...
    CarSpecs(mass=3206., wheelbase=3.08, steerRatio=14.15),
  )
...
FW_QUERY_CONFIG = FwQueryConfig(
  requests=[
    ...
    Request(
      [StdQueries.TESTER_PRESENT_REQUEST, MG_VERSION_REQUEST],
      [StdQueries.TESTER_PRESENT_RESPONSE, MG_VERSION_RESPONSE],
      rx_offset=0x40,
      bus=0,
      logging=True,
    ),
