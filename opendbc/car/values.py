...
from opendbc.car.pinball.values import CAR as PINBALL
...
Platform = BODY | BYD | CHRYSLER | FORD | GM | HONDA | HYUNDAI | MAZDA | MOCK | MG | NISSAN | PINBALL | PSA | RIVIAN | SUBARU | TESLA | TOYOTA | VOLKSWAGEN
