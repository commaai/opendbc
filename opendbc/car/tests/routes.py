...
routes = [
  ...
  CarTestRoute("", VOLKSWAGEN.VOLKSWAGEN_GOLF_MK8),  # TODO VW MQBevo
  ...
  CarTestRoute("", VOLKSWAGEN.CUPRA_BORN_MK1), # TODO VW MEB
  CarTestRoute("", VOLKSWAGEN.SKODA_ENYAQ_MK2, # TODO VW MEB GEN2
