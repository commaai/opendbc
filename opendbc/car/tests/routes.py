...
routes = [
  ...
  CarTestRoute("ad9840558640c31d/0000002e--a81d0c52a8", HONDA.ACURA_MDX_4G_MMR), # initial route, todo: update after roadtest
  ...
  CarTestRoute("ad9840558640c31d/00000024--9ecb0dba75", HONDA.ACURA_MDX_4G_MMR),
