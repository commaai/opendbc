...
from opendbc.car.lateral import ANGLE_AVERAGE_ROAD_ROLL, ISO_LATERAL_ACCEL, apply_std_steer_angle_limits
...
MAX_LATERAL_ACCEL = ISO_LATERAL_ACCEL - (ACCELERATION_DUE_TO_GRAVITY * ANGLE_AVERAGE_ROAD_ROLL)  # ~2.4 m/s^2
