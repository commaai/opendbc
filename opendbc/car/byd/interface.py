...
class CarInterface(CarInterfaceBase):
    ...
    def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, experimental_long, docs) -> structs.CarParams:  # type: ignore
        ...
        ret.steerActuatorDelay = 0.2  # Measured at 0.4s, however in torqued.py, line 55, code will add 0.2
        ret.steerLimitTimer = 0.4

        ret.lateralTuning.init('pid')
        ret.lateralTuning.pid.kpBP, ret.lateralTuning.pid.kiBP = [[10., 40.], [10., 40.]]
        ret.lateralTuning.pid.kpV, ret.lateralTuning.pid.kiV = [[0.16, 0.33], [0.015, 0.025]]
