...
class CarState(CarStateBase):
    ...
    def update(self, cp, cp_cam, *_) -> structs.CarState: # type: ignore
        ...
        ret.cruiseState.enabled = (self.acc_state == 3) or (self.acc_state == 5)
        ...
        ret.steerFaultPermanent = (cp.vl["ACC_EPS_STATE"]["TorqueFailed"] == 1) #EPS give up all inputs until restart
