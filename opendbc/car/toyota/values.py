...
class ToyotaTSS2PlatformConfig(PlatformConfig):
  dbc_dict: dict = field(default_factory=lambda: toyota_dbc_dict('toyota_nodsu_pt_generated', 'toyota_tss2_adas'))
...
class CAR(Platforms):
  ...
  TOYOTA_AVALON = PlatformConfig(
    ...
    toyota_dbc_dict('toyota_tnga_k_pt_generated', 'toyota_adas'),
  )
  TOYOTA_AVALON_2019 = PlatformConfig(
    ...
    TOYOTA_AVALON.specs,
    toyota_dbc_dict('toyota_nodsu_pt_generated', 'toyota_adas'),
  )
  ...
  TOYOTA_COROLLA = PlatformConfig(
    ...
    toyota_dbc_dict('toyota_new_mc_pt_generated', 'toyota_adas'),
  )
  ...
  TOYOTA_RAV4_PRIME = PlatformConfig(
    ...
    toyota_dbc_dict('toyota_rav4_prime_generated', 'toyota_tss2_adas'),
