...
def create_ui_command(packer, steer, chime, left_line, right_line, left_lane_depart, right_lane_depart, enabled, stock_lkas_hud, main_enabled):
  lane_depart = left_lane_depart or right_lane_depart
  values = {
    "TWO_BEEPS": chime,
    "LDA_ALERT": steer,
    ...
    "LKAS_STATUS": 3 if lane_depart else 2 if enabled else 1 if main_enabled else 0,
