...
def acc_control_value(main_switch_on, acc_faulted, long_active, long_override=False):
  if acc_faulted:
    acc_control = 6
  elif long_active:
    acc_control = 4 if long_override else 3
  elif main_switch_on:
    acc_control = 2
  else:
    acc_control = 0
...
def acc_hud_status_value(main_switch_on, acc_faulted, long_active, long_override=False):
