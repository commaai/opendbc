...
class CAR(Platforms):
  RIVIAN_R1_GEN1 = RivianPlatformConfig(
    # TODO: verify this
    [
      RivianCarDocs("Rivian R1S 2022-24", video='https://www.youtube.com/watch?v=NHbC9cuLzTg'),
      RivianCarDocs("Rivian R1T 2022-24", video='https://www.youtube.com/watch?v=4LMAwHxjxig'),
    ],
