...
class CAR(Platforms):
  ...
  ACURA_RDX_3G_MMR = HondaBoschPlatformConfig(
    [HondaCarDocs("Acura RDX 2022", "All", footnotes=[Footnote.STEER_LIMITING_RADAR])],
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    ...
    Ecu.vsa: [CAR.ACURA_RDX_3G, CAR.ACURA_RDX_3G_MMR, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CIVIC_2022, CAR.HONDA_CRV_5G, \
              CAR.HONDA_CRV_HYBRID, CAR.HONDA_E, CAR.HONDA_HRV_3G, CAR.HONDA_INSIGHT, CAR.HONDA_ODYSSEY_5G_MMR],
  },
  extra_ecus=[
...
HONDA_BOSCH_1000 = {CAR.HONDA_ODYSSEY_5G_MMR, CAR.ACURA_RDX_3G_MMR} # overrides for 1000 gas units per m/s accel
