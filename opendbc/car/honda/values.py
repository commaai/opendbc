...
class CAR(Platforms):
  ...
  HONDA_PASSPORT_4G = HondaBoschCANFDPlatformConfig(
    ...
    CarSpecs(mass=4620 * CV.LB_TO_KG, wheelbase=2.89, centerToFrontRatio=0.442, steerRatio=16.5),  # TODO: recheck CTF ratio
  )
  # mid-model refresh
...
FW_QUERY_CONFIG = FwQueryConfig(
  ...
  non_essential_ecus={
    ...
    Ecu.vsa: [CAR.ACURA_RDX_3G, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CRV_5G, CAR.HONDA_CRV_HYBRID,
              CAR.HONDA_E, CAR.HONDA_INSIGHT, CAR.HONDA_NBOX_2G, *HONDA_BOSCH_RADARLESS, *HONDA_BOSCH_CANFD],
  },
  extra_ecus=[
