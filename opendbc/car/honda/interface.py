...
from opendbc.car.honda.values import CarControllerParams, HondaFlags, CAR, HONDA_BOSCH, HONDA_BOSCH_CANFD_CAR, \
...
class CarInterface(CarInterfaceBase):
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint, car_fw, alpha_long, docs) -> structs.CarParams:
    ...
    if candidate in HONDA_BOSCH_CANFD_CAR:
      ...
      ret.alphaLongitudinalAvailable = False  # TODO: get this working
      ret.openpilotLongitudinalControl = False  # TODO: get this working
