...
def get_can_messages(CP, gearbox_msg):
  ...
  # TODO: clean this up
  if CP.carFingerprint in (CAR.HONDA_NBOX, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CIVIC_BOSCH_DIESEL, CAR.HONDA_CRV_HYBRID, CAR.HONDA_INSIGHT,
...
class CarState(CarStateBase):
  def __init__(self, CP):
    ...
    if CP.carFingerprint == CAR.HONDA_NBOX or (CP.carFingerprint == CAR.HONDA_ACCORD and CP.transmissionType == TransmissionType.cvt):
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.carFingerprint in (CAR.HONDA_NBOX, CAR.HONDA_ACCORD, CAR.HONDA_CIVIC_BOSCH, CAR.HONDA_CIVIC_BOSCH_DIESEL, CAR.HONDA_CRV_HYBRID,
                                  CAR.HONDA_INSIGHT, CAR.ACURA_RDX_3G, CAR.HONDA_E, CAR.HONDA_CIVIC_2022, CAR.HONDA_HRV_3G):
