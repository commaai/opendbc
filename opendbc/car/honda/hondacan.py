...
def create_acc_commands(packer, CAN, enabled, active, accel, gas, stopping_counter, car_fingerprint, extra_brake):
  commands = []
  ...
  braking = 1 if active and (accel + extra_brake) < min_gas_accel else 0
