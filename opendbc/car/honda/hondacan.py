...
def get_cruise_speed_conversion(car_fingerprint: str, is_metric: bool) -> float:
  ...
  return CV.MPH_TO_MS if car_fingerprint in (HONDA_BOSCH_RADARLESS | HONDA_BOSCH_CANFD | {CAR.ACURA_RDX_3G_MMR, CAR.HONDA_ODYSSEY_5G_MMR}) and not is_metric else CV.KPH_TO_MS
