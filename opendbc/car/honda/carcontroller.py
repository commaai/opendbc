...
class CarController(CarControllerBase):
  ...
  def update(self, CC, CS, now_nanos):
    ...
    if self.frame % 10 == 0:
      ...
      can_sends.extend(hondacan.create_ui_commands(self.packer, self.CAN, self.CP, main_on, CC.enabled, CC.latActive, CS.out.steeringPressed,
                                                   pcm_speed, hud, CS.is_metric, CS.acc_hud, CS.lkas_hud))
