...
def get_friction(lateral_accel_error: float, lateral_accel_deadzone: float, friction_thresholdLateral: float,
  ...
  return float(torque_params.friction * torque_params.latAccelFactor * np.tanh(10 * apply_center_deadzone(lateral_accel_error, lateral_accel_deadzone)))
