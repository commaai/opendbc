...
from opendbc.car.docs_definitions import BaseCarHarness, CarDocs, Device, ExtraCarDocs, Column, DEFAULT_CAR_PARTS, ExtraCarsColumn, CommonFootnote, PartType
...
def generate_cars_md(all_car_docs: list[CarDocs], template_fn: str) -> str:
  ...
  cars_md: str = template.render(all_car_docs=all_car_docs, PartType=PartType,
                                 ...
                                 Device=Device, Column=Column, DEFAULT_CAR_PARTS=DEFAULT_CAR_PARTS,
