...
class CarState(CarStateBase):
  ...
  def update_summon_state(self, autopark_state: str, cruise_enabled: bool):
    summon_now = autopark_state in ("ACTIVE", "COMPLETE", "SELFPARK_STARTED")
  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    # DI_autoparkState is set by Summon, not Autopark
    ...
    self.update_summon_state(autopark_state, cruise_enabled)
