...
from opendbc.car import CarSpecs, DbcDict, PlatformConfig, Platforms
...
class SubaruPlatformConfig(PlatformConfig):
  dbc_dict: DbcDict = field(default_factory=lambda: {'pt': 'subaru_global_2017_generated'})

  def init(self):
    if self.flags & SubaruFlags.HYBRID:
      self.dbc_dict = {'pt': 'subaru_global_2020_hybrid_generated'}
...
class CAR(Platforms):
  ...
  SUBARU_FORESTER_PREGLOBAL = SubaruPlatformConfig(
    ...
    {'pt': 'subaru_forester_2017_generated'},
  ...
  SUBARU_LEGACY_PREGLOBAL = SubaruPlatformConfig(
    ...
    {'pt': 'subaru_outback_2015_generated'},
    flags=SubaruFlags.PREGLOBAL,
  )
  ...
  SUBARU_OUTBACK_PREGLOBAL_2018 = SubaruPlatformConfig(
    ...
    SUBARU_FORESTER_PREGLOBAL.specs,
    {'pt': 'subaru_outback_2019_generated'},
    flags=SubaruFlags.PREGLOBAL,
  )
  # Angle LKAS
