...
FW_VERSIONS = {
  CAR.MAZDA_CX5_2022: {
    ...
    (Ecu.fwdCamera, 0x706, None): [
      ...
      b'l\x80\x90\x00r\x84$\x00\x00\x10ec\x00\x00\x00\x00\x00',
    ],
    (Ecu.transmission, 0x7e1, None): [
      ...
      b'\xf1\x10\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
  },
  CAR.MAZDA_CX5: {
    (Ecu.eps, 0x730, None): [
