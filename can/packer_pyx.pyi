...
class CANPacker():
  ...
  def pack(self, addr: int, values: Dict[str, float], counter: int) -> List[int]: ...
  
  def make_can_msg(self, name_or_addr: str|int, bus: int, values: Dict[str, float], counter=-1) -> List[int] : ...